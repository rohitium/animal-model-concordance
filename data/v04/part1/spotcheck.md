...
Built 2026-09-14 from 1494 final results in 406 studies. Sample A seed 20260914, sample B seed 20260915; both redrawable by re-running `t1_part1_outputs.py`.
...
### A2. Plasma-to-tumour tissue integrated proteomics using nano-omics for biomarker discovery in glioblastoma
...
### A3. Cntnap2-dependent molecular networks in autism spectrum disorder revealed through an integrative multi-omics a
...
### A4. Identification of conserved canonical marker genes in human and mouse adrenal glands using Visium spatial tran
...
### A5. Know Thy Model: Charting Molecular Homology in Stromal Reprogramming Between Canine and Human Mammary Tumors
...
### A6. Cross-species single-cell landscapes identify the pathogenic gene characteristics of inherited retinal disease
...
### A7. Concordance of the Toxicity of Pharmaceuticals in Humans and in Animals
...
### A8. Tripartite factors leading to molecular divergence between human and murine smooth muscle
...
### A9. Translating medication effects for alcohol use disorder across preclinical, human laboratory, and clinical tri
...
### A10. An integrated analysis of genes and functional pathways for aggression in human and rodent models
...
### A11. Expression profiles of the autism-related SHANK proteins in the human brain
...
### A12. Complement response to burn injury: systematic review and meta-analysis of patient and animal studies
...
### A13. Transcriptomic evidence for immaturity of the prefrontal cortex in patients with schizophrenia
...
### A14. Amphetamine increases motivation of humans and mice as measured by breakpoint, but does not affect an Electroe
...
### A15. A multimodal cross-species comparison of pancreas development
...
### A16. The dog as an animal model for bladder and urethral urothelial carcinoma: Comparative epidemiology and histolo
...
### A17. Transcriptomic Cross‐Species Analysis of Chronic Liver Disease Reveals Consistent Regulation Between Humans an
...
### A18. Bridging the Gap Between Fluid Biomarkers for Alzheimer’s Disease, Model Systems, and Patients
...
### A19. Acquired resistance to the RAS(ON) multi-selective inhibitor daraxonrasib guides rational combination therapy 
...
### A20. Transcriptomic classification of genetically engineered mouse models of breast cancer identifies human subtype
...
### A21. Phosphoproteomics reveals conserved exercise‐stimulated signaling and AMPK regulation of store‐operated calciu
...
### A22. Plasma Chemokines in Patients with Alcohol Use Disorders: Association of CCL11 (Eotaxin-1) with Psychiatric Co
...
### A23. Comparative HPLC-MSn analysis of canine and human meibomian lipidomes: many similarities, a few differences
...
### A24. A comparative encyclopedia of DNA elements in the mouse genome
...
### A25. Comparative developmental genomics of sex-biased gene expression in early embryogenesis across mammals
...
### A26. Know Thy Model: Charting Molecular Homology in Stromal Reprogramming Between Canine and Human Mammary Tumors
2019 · Frontiers in Cell and Developmental Biology · record 31921858 · adjudicated by **model**
...
### A27. Concordant and discordant gene expression patterns in mouse strains identify best-fit animal model for human t
...
### A28. Distinct pathogenic roles for resident and monocyte-derived macrophages in lupus nephritis
2022 · JCI Insight · record 36345939 · adjudicated by **hand**

- **Open:** [PubMed](https://pubmed.ncbi.nlm.nih.gov/36345939/) · [DOI](https://doi.org/10.1172/jci.insight.159751) · local PDF `data/raw/fulltext/36345939.pdf` · **go to PDF page 9**
- **Statement:** All top 10 MNP1.4 TF regulons were increased in human TrMacs in lupus nephritis, including STAT1.
- **Value:** — · species `mouse` · level C · direction animal-corresponded · immunology-inflammation
- **Quote:** “All the top 10 MNP1.4 TF regulons were increased in human TrMacs in lupus nephritis, including STAT1 (Supplemental Figure 5A), and many of the top 10 MNP2.3 TF regulons were increased in MoMacs (Supplemental Figure 5B).”
- **Check:** ☐ ✓   ☐ ✗ → failed (a / b / c / d): ______  note: ______

### A29. Cross-species single-cell transcriptomic analysis reveals divergence of cell composition and functions in mamm
2022 · Cell Regeneration · record 35511361 · adjudicated by **hand**

- **Open:** [PubMed](https://pubmed.ncbi.nlm.nih.gov/35511361/) · [DOI](https://doi.org/10.1186/s13619-022-00118-7) · local PDF `data/raw/fulltext/35511361.pdf` · **go to PDF page 7**
- **Statement:** The expression of drug metabolism genes in mouse ileum showed a correlation of 0.71 with human ileum.
- **Value:** 0.71 correlation · species `mouse` · level C · direction animal-corresponded · cross-cutting-toxicology
- **Quote:** “The expression of drug metabolism genes in mouse ileum showed the highest correlation with that in human (R=0.71), whereas the ones in other species showed lower correlation (R = 0.45-0.48).”
- **Check:** ☐ ✓   ☐ ✗ → failed (a / b / c / d): ______  note: ______

### A30. ZeGlobalTox: An Innovative Approach to Address Organ Drug Toxicity Using Zebrafish
2017 · International Journal of Molecular Sciences · record 28422076 · adjudicated by **model**

- **Open:** [PubMed](https://pubmed.ncbi.nlm.nih.gov/28422076/) · [DOI](https://doi.org/10.3390/ijms18040864) · local PDF `data/raw/fulltext/28422076.pdf` · **go to PDF page 10**
- **Statement:** The ZeGlobalTox assay showed a specificity of 100% for neurotoxicity.
- **Value:** 100.0 percent · species `zebrafish` · level A · direction animal-corresponded · neurology
- **Quote:** “Specificity	90%	100%	77%	89%”
- **Check:** ☐ ✓   ☐ ✗ → failed (a / b / c / d): ______  note: ______
