...
Built 2026-09-15 from 1518 final results in 418 studies. Sample A seed 20260914, sample B seed 20260915; both redrawable by re-running `t1_part1_outputs.py`.
...
- **Statement:** The positive predictive value (PPV) for PDX drug screens was 85% (80/94).
- **Value:** 85 percent (n 80/94) · species `mouse` · level A · direction animal-corresponded · oncology
- **Quote:** “This resulted in positive and negative predictive values (PPVs and NPVs) of 85% and 91%, respectively. ... Table 1. Values and confidence intervals for parameters of analytical and clinical accuracy for PDX model drug screening ... Overall ... PPV 85% (80/94) 76%-91%”
- **Check:** ☐ ✓   ☐ ✗ → failed (a / b / c / d): ______  note: ______
...
### A9. Tripartite factors leading to molecular divergence between human and murine smooth muscle
...
### A10. Patient-derived xenografts effectively capture responses to oncology therapy in a heterogeneous cohort of pati
2017 · Annals of Oncology · record 28945830 · adjudicated by **hand**
...
- **Statement:** When treatment followed other therapies received after tumor collection, the sensitivity of PDX drug screens was 96% (51/53).
- **Value:** 96 percent (n 51/53) · species `mouse` · level A · direction animal-corresponded · oncology
- **Quote:** “Table 1. Values and confidence intervals for parameters of analytical and clinical accuracy for PDX model drug screening ... Treatment follows other therapies received after tumor collection ... Sensitivity 96% (51/53) 86%-99%”
- **Check:** ☐ ✓   ☐ ✗ → failed (a / b / c / d): ______  note: ______

### A11. Translating medication effects for alcohol use disorder across preclinical, human laboratory, and clinical tri
...
### A12. An integrated analysis of genes and functional pathways for aggression in human and rodent models
...
### A13. Expression profiles of the autism-related SHANK proteins in the human brain
...
### A14. Complement response to burn injury: systematic review and meta-analysis of patient and animal studies
...
### A15. Transcriptomic evidence for immaturity of the prefrontal cortex in patients with schizophrenia
...
### A16. Amphetamine increases motivation of humans and mice as measured by breakpoint, but does not affect an Electroe
...
### A17. A multimodal cross-species comparison of pancreas development
...
### A18. The dog as an animal model for bladder and urethral urothelial carcinoma: Comparative epidemiology and histolo
...
### A19. Transcriptomic Cross‐Species Analysis of Chronic Liver Disease Reveals Consistent Regulation Between Humans an
...
### A20. Bridging the Gap Between Fluid Biomarkers for Alzheimer’s Disease, Model Systems, and Patients
...
### A21. Acquired resistance to the RAS(ON) multi-selective inhibitor daraxonrasib guides rational combination therapy 
...
### A22. Transcriptomic classification of genetically engineered mouse models of breast cancer identifies human subtype
...
### A23. Phosphoproteomics reveals conserved exercise‐stimulated signaling and AMPK regulation of store‐operated calciu
...
### A24. Plasma Chemokines in Patients with Alcohol Use Disorders: Association of CCL11 (Eotaxin-1) with Psychiatric Co
...
### A25. Comparative HPLC-MSn analysis of canine and human meibomian lipidomes: many similarities, a few differences
...
### A26. A comparative encyclopedia of DNA elements in the mouse genome
...
### A27. Comparative developmental genomics of sex-biased gene expression in early embryogenesis across mammals
...
### A28. Know Thy Model: Charting Molecular Homology in Stromal Reprogramming Between Canine and Human Mammary Tumors
2019 · Frontiers in Cell and Developmental Biology · record 31921858 · adjudicated by **model**
...
### A29. Concordant and discordant gene expression patterns in mouse strains identify best-fit animal model for human t
...
### A30. Distinct pathogenic roles for resident and monocyte-derived macrophages in lupus nephritis
